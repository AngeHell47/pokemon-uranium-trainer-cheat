...
static void build_ruby() {
    ...
    _snprintf_s(
        ...
        "  if defined?(PokeBattle_Pokemon) && PokeBattle_Pokemon.method_defined?(:eggsteps)\n"
        "    class PokeBattle_Pokemon\n"
        "      unless method_defined?(:__uranium_trainer_original_eggsteps)\n"
        "        alias_method :__uranium_trainer_original_eggsteps, :eggsteps\n"
        "        def eggsteps\n"
        "          steps=__uranium_trainer_original_eggsteps\n"
